...
export const themeScript = `var p=localStorage.getItem("${APPEARANCE_KEY}"),q=window.matchMedia("(prefers-color-scheme: dark)"),d=${
  DEFAULT_APPEARANCE === "dark"
}&&null==p||("auto"===p||null==p?q.matches:"dark"===p);document.documentElement.classList[d?"add":"remove"]("dark");`;
